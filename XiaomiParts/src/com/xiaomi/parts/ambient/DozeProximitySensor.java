...
public class DozeProximitySensor implements SensorEventListener {

    private static final boolean DEBUG = false;
    private static final String TAG = "DozeProximitySensor";
    ...
    public DozeProximitySensor(Context context) {
        mContext = context;
